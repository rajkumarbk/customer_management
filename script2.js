// ---------- Example datasets ----------
const staffData = {
  "101": ["Ali", "Hassan", "Faisal"],
  "102": ["Salman", "Omar", "Bader"],
  "103": ["Khalid", "Yousef", "Faris"],
  "104": ["Fahad", "Ahmed", "Rayan"],
  "105": ["Mohammed", "Ibrahim", "Adel"],
  "106": ["Saad", "Talal", "Ziad"],
  "107": ["Majid", "Sultan", "Emad"],
  "108": ["Nasser", "Adnan", "Hatem"],
...
function setNow(input) {
  ...
  console.log("KSA Time Set:", formatted);
}
...
// ✅ Now start & end inputs are defined
if (!editing) {
  setNow(start);
  setNow(end);
}
